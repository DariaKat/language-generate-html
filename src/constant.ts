...
export const typeInput = [
  { id: 1, value: "ПАРОЛЬ", name: "пароль" },
  { id: 2, value: "ТЕКСТ", name: "текст" },
  { id: 3, value: "ЧЕКБОКС_КНОПКА", name: "чекбокс-кнопка" },
  { id: 4, value: "ПОЧТА", name: "почта" },
  { id: 5, value: "РАДИО_КНОПКА", name: "радио-кнопка" },
];
